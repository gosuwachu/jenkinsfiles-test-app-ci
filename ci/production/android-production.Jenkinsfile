pipeline {
    ...
    stages {
        ...
        stage('Android Production Build') {
            steps {
                script {
                ...
                withCredentials([usernamePassword(credentialsId: 'github-app',
                    ...
                    script {
                        env.CONTEXT_JSON = sh(
                            script: """./ci-cli android production-build \
        ...
        stage('Trigger Android Production Deploy') {
            steps {
                build job: 'mobile-app-support/omnibus',
                      parameters: [
                          ...
                          string(name: 'JENKINSFILE', value: 'ci/production/android-production-deploy.Jenkinsfile'),
