pipeline {
    ...
    stages {
        ...
        stage('iOS Production Build') {
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'github-app',
                    ...
                    script {
                        env.CONTEXT_JSON = sh(
                            script: """./ci-cli ios production-build \
        ...
        stage('Trigger iOS Production Deploy') {
            steps {
                build job: 'mobile-app-support/omnibus',
                      parameters: [
                          ...
                          string(name: 'JENKINSFILE', value: 'ci/production/ios-production-deploy.Jenkinsfile'),
